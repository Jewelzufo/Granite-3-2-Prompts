...
```  
Prompt: "Generate a structured agenda for a '[Meeting Topic]' meeting, including time allocations and key discussion points.  
Context: '[Paste Meeting Objective Here]'"  
```  
...
```  
Prompt: "Categorize the following emails into 'Urgent', 'Follow-Up', or 'Archive' and draft brief responses for urgent messages.  
Emails: '[Paste Emails Here]'"  
```  

---

### 3. **Document Translation & Localization**  
```  
Prompt: "Translate the following internal document into French while adapting idioms and terminology for the Quebec market.  
Document: '[Paste Text Here]'"  
```  

---

### 4. **Expense Report Auditing**  
```  
Prompt: "Flag policy violations in the following expense reports (e.g.,超标 spending, missing receipts). Highlight discrepancies.  
Reports: '[Paste Expense Data Here]'"  
```  

---

### 5. **Customer Query Categorization**  
```  
Prompt: "Classify customer queries into 'Billing', 'Technical Support', 'Product Info', or 'Returns'. Prioritize urgent cases.  
Queries: '[Paste Messages Here]'"  
```  
...
```  
Prompt: "Generate 5 LinkedIn posts promoting '[Product/Service]' aligned with our brand voice. Include hashtags and emojis.  
Key Points: '[Paste Product Details Here]'"  
```  
...
```  
Prompt: "Summarize strengths, weaknesses, and market positioning of '[Competitor]' based on the following news/articles.  
Sources: '[Paste URLs/Text Here]'"  
```  
...
```  
Prompt: "Identify top 3 employee concerns from the following survey responses and suggest actionable improvements.  
Responses: '[Paste Survey Data Here]'"  
```  

---

### 9. **IT Helpdesk Ticket Resolution**  
```  
Prompt: "Generate step-by-step troubleshooting guides for the following IT issues. Use simple language for non-technical users.  
Issues: '[Paste Ticket Descriptions Here]'"  
```  
...
```  
Prompt: "Generate a bullet-point summary of Q3 sales performance vs. targets, highlighting underperforming regions.  
Data: '[Paste Sales Metrics Here]'"  
```  

---

### 11. **Content Plagiarism Checker**  
```  
Prompt: "Compare the following document against internal knowledge bases to detect potential plagiarism. Highlight matches.  
Document: '[Paste Text Here]'"  
```  

---

### 12. **Vendor Contract Renewal Tracker**  
```  
Prompt: "Extract expiration dates and renewal terms from the following vendor contracts. Flag contracts expiring in <30 days.  
Contracts: '[Paste Text/Images Here]'"  
```  

---

### 13. **Project Timeline Optimizer**  
```  
Prompt: "Identify bottlenecks in the following project plan and suggest timeline adjustments. Highlight resource dependencies.  
Plan: '[Paste Gantt Chart/Details Here]'"  
```  

---

### 14. **Recruitment Email Templates**  
```  
Prompt: "Draft personalized outreach emails to candidates for the '[Role]' position. Include role-specific selling points.  
Candidate Profiles: '[Paste Resumes/LinkedIn Data Here]'"  
```  

---

### 15. **Data Entry Validation**  
```  
Prompt: "Cross-check the following manually entered data against source documents. Highlight inconsistencies.  
Data: '[Paste Entries Here]'"  
```  

---

### 16. **Brand Voice Consistency Check**  
```  
Prompt: "Audit the following marketing copy to ensure alignment with our brand guidelines (tone: professional, concise).  
Copy: '[Paste Text Here]'"  
```  

---

### 17. **Event Planning Logistics**  
```  
Prompt: "Generate a checklist for hosting '[Event Name]' including venue requirements, vendor contacts, and risk mitigation steps.  
Details: '[Paste Event Scope Here]'"  
```  

---

### 18. **Travel Itinerary Organizer**  
```  
Prompt: "Optimize the following business travel itinerary for efficiency, grouping meetings by location and suggesting transport options.  
Details: '[Paste Schedule Here]'"  
```  
...
```  
Prompt: "Identify outdated sections in the following knowledge base articles and suggest updates based on new product features.  
Articles: '[Paste Content Here]'"  
```  

---

### 20. **Automated Policy Updates**  
```  
Prompt: "Revise the following company policy document to reflect recent regulatory changes. Highlight edited sections.  
Policy: '[Paste Document Here]'"  
```  

--- 

**Key Features Leveraged**:  
- **Granite-Vision-3.2-2B** for processing scanned invoices, contracts, and images.  
- **Multilingual NLP** for global team collaboration and localization.  
- **RAG integration** for real-time data validation and compliance checks.  

Replace placeholders (e.g., `[Paste Data Here]`) with actual inputs to deploy immediately.